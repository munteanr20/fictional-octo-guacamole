...
// Iconiță PLACEHOLDER pentru cardurile de echipă
export const UserIcon = () => (
  <svg className="w-24 h-24 mx-auto text-gray-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
